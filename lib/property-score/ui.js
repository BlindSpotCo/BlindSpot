...
export function GradeBadge({ grade, color }) {
  return (
    <span style={{
      display: 'inline-block', fontFamily: "'Geist Mono', monospace", fontSize: 12,
...
export function FactorBar({ label, score }) {
  ...
  return (
    <div style={{ marginBottom: 10 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12.5, color: 'var(--text-mute)', marginBottom: 4 }}>
