...
function normalizeWeights(w) {
  ...
  const total = merged.sun + merged.shadeHeat + merged.view + merged.privacy + merged.wind + merged.dampness;
...
export async function computeLiveScore(input) {
  ...
  const subScores = [sunScore, shadeHeatScore, viewScore, privacyScore, windScore, dampnessScore];
