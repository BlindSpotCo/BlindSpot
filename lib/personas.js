...
export const PERSONAS = {
  ...
  family_buyer: {
    ...
    reportOverlay: {
      ...
      toneNote: 'Calm, complete, unhedged. Longer sentences are fine. Do not reassure. If crime, water or power sits in a weak band, state it inside the BlindSpot Summary paragraph itself, not only later - this reader is the one a soft-pedalled warning actually harms.',
    },
  },
  investor: {
    id: 'investor',
