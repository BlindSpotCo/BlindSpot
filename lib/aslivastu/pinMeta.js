...
export const PIN_META = {
  ...
  // ── Chandigarh (city 3) ──
  "160001":{ name:"Sector 1 · Capitol Complex", area:"North Chandigarh", city:"Chandigarh", sectors:[1], aliases:["Capitol Complex","High Court","New Secretariat"] },
  ...
  "160014":{ name:"Sector 14 · Panjab Univ.", area:"West Chandigarh", city:"Chandigarh", sectors:[14], aliases:["Panjab University","PU"] },
  "160015":{ name:"Sectors 15-16", area:"Central Chandigarh", city:"Chandigarh", sectors:[15,16] },
  "160017":{ name:"Sector 17 · City Centre", area:"Central Chandigarh", city:"Chandigarh", sectors:[17], aliases:["GPO","City Centre","Bus Stand"] },
  "160018":{ name:"Sector 18", area:"Central Chandigarh", city:"Chandigarh", sectors:[18], aliases:["Government Press"] },
  "160019":{ name:"Sectors 6-7, 19, 26-27", area:"East Chandigarh", city:"Chandigarh", sectors:[6,7,19,26,27] },
  "160020":{ name:"Sector 20", area:"Central Chandigarh", city:"Chandigarh", sectors:[20] },
  "160022":{ name:"Sectors 21-22, 34-35", area:"Central Chandigarh", city:"Chandigarh", sectors:[21,22,34,35], aliases:["Sub City Centre"] },
  "160023":{ name:"Sector 23", area:"Central Chandigarh", city:"Chandigarh", sectors:[23] },
  "160030":{ name:"Sector 30", area:"East Chandigarh", city:"Chandigarh", sectors:[30] },
  "160036":{ name:"Sectors 36-43", area:"South Chandigarh", city:"Chandigarh", sectors:[36,37,38,39,40,41,42,43], aliases:["ISBT 43","Bus Stand 43"] },
  "160047":{ name:"Sectors 31, 44, 47", area:"South Chandigarh", city:"Chandigarh", sectors:[31,44,47] },
  // 160002 covers BOTH industrial phases -- Elante sits in Phase I and
  // still carries 160002, verified against its published address -- so
  // both phases are listed rather than just the Phase 2 the postal
  // listing names.
  "160002":{ name:"Ram Darbar · Industrial Area", area:"South-East Chandigarh", city:"Chandigarh", aliases:["Industrial Area Phase 1","Industrial Area Phase 2","Ram Darbar","Elante","Nexus Elante"] },
  "160101":{ name:"Manimajra", area:"East Chandigarh", city:"Chandigarh", aliases:["Mani Majra","Motor Market"] },
}
