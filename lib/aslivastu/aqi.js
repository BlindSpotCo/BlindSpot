...
//
// The fix is to stop depending on that snapshot: /api/aqi resolves a live
// nearest-station reading from the pin's own coordinates, which every pin
// in the dataset has, so there's no coverage gap to patch by hand.
