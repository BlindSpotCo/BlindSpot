...
// (data/aslivastu/nqi_scores.json) groups everything under 7 fixed city
...
// Matches a free-text place name against the 7 covered cities. Returns
...
// (Pune, Kolkata, ...) -- a real, expected outcome, not an
// error, since the search box now surfaces city-level results everywhere
// in India, not just the 7 covered metros.
