...
// (data/aslivastu/nqi_scores.json) groups everything under 8 fixed city
...
// Matches a free-text place name against the 8 covered cities. Returns
...
// (Pune, Jaipur, ...) -- a real, expected outcome, not an
// error, since the search box now surfaces city-level results everywhere
// in India, not just the 8 covered metros.
