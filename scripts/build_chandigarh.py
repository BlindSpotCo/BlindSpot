...
- Power distribution moved from the UT Electricity Dept to Chandigarh
  ...
  Confirmed with specific recent reporting (The Tribune, June 2025):
  frequent day- and night-time outages across multiple sectors (30-B, 36,
  48 named), CPDL citing underground cable faults and transformer
  overloading, and the complaint helpline expanded from 20 to 50 lines
  under the load. This is city-wide, not concentrated in any one sector
  -- CPDL is a single UT-wide grid, unlike Mumbai's real multi-DISCOM
  split -- so as of this pass power is a single flat, disclosed anchor
  (58/100, no per-pincode variation) rather than the per-sector spread
  the PROFILE table used to carry, which had no real per-sector power
  source behind it (every other PROFILE field in this dict is still
  genuinely per-pincode; power specifically was not).
...
PROFILE = {
    "160001": dict(crime=88, air=72, power=58, schools=62, water=94, roads=93, sewerage=88,
                   crimes=118, aqi=86, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=9, tds="Low",
                   wcov=99, road="Excellent", pot=0.6, resurf=2024, wlog=5, flood=0, zone="Institutional",
                   hwy="Medium", planned=2, schools_n=3),
    "160009": dict(crime=85, air=71, power=58, schools=78, water=93, roads=90, sewerage=87,
                   crimes=141, aqi=88, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=8, tds="Low",
                   wcov=98, road="Excellent", pot=0.8, resurf=2023, wlog=5, flood=0, zone="Residential",
                   hwy="Medium", planned=2, schools_n=7),
    "160011": dict(crime=84, air=70, power=58, schools=74, water=92, roads=89, sewerage=86,
                   crimes=152, aqi=90, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=8, tds="Low",
                   wcov=98, road="Excellent", pot=0.9, resurf=2023, wlog=4, flood=1, zone="Residential",
                   hwy="Medium", planned=1, schools_n=6),
    "160012": dict(crime=86, air=73, power=58, schools=81, water=93, roads=91, sewerage=87,
                   crimes=133, aqi=85, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=9, tds="Low",
                   wcov=99, road="Excellent", pot=0.7, resurf=2025, wlog=5, flood=0, zone="Institutional",
                   hwy="High", planned=2, schools_n=9),
    "160014": dict(crime=83, air=74, power=58, schools=86, water=92, roads=88, sewerage=85,
                   crimes=164, aqi=84, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=8, tds="Low",
                   wcov=97, road="Excellent", pot=1.1, resurf=2022, wlog=4, flood=1, zone="Institutional",
                   hwy="Medium", planned=1, schools_n=11),
    "160015": dict(crime=80, air=68, power=58, schools=79, water=90, roads=86, sewerage=83,
                   crimes=198, aqi=95, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=8, tds="Medium",
                   wcov=97, road="Good", pot=1.4, resurf=2022, wlog=4, flood=1, zone="Residential",
                   hwy="Medium", planned=1, schools_n=8),
    "160017": dict(crime=71, air=64, power=58, schools=58, water=89, roads=87, sewerage=81,
                   crimes=402, aqi=104, aqi_cat="Moderate", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=99, road="Excellent", pot=1.0, resurf=2024, wlog=3, flood=2, zone="Commercial",
                   hwy="High", planned=3, schools_n=2),
    "160018": dict(crime=79, air=67, power=58, schools=71, water=89, roads=85, sewerage=82,
                   crimes=214, aqi=97, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=96, road="Good", pot=1.5, resurf=2021, wlog=4, flood=1, zone="Mixed",
                   hwy="High", planned=2, schools_n=5),
    "160019": dict(crime=81, air=69, power=58, schools=83, water=91, roads=87, sewerage=84,
                   crimes=187, aqi=93, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=8, tds="Low",
                   wcov=97, road="Good", pot=1.2, resurf=2023, wlog=4, flood=1, zone="Residential",
                   hwy="Medium", planned=2, schools_n=10),
    "160020": dict(crime=78, air=66, power=58, schools=69, water=88, roads=84, sewerage=80,
                   crimes=231, aqi=99, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=95, road="Good", pot=1.7, resurf=2021, wlog=3, flood=2, zone="Residential",
                   hwy="Medium", planned=1, schools_n=4),
    "160022": dict(crime=74, air=65, power=58, schools=76, water=88, roads=85, sewerage=79,
                   crimes=318, aqi=101, aqi_cat="Moderate", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=96, road="Good", pot=1.6, resurf=2022, wlog=3, flood=2, zone="Mixed",
                   hwy="High", planned=3, schools_n=9),
    "160023": dict(crime=80, air=67, power=58, schools=72, water=89, roads=86, sewerage=81,
                   crimes=205, aqi=96, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=96, road="Good", pot=1.3, resurf=2023, wlog=4, flood=1, zone="Residential",
                   hwy="Medium", planned=1, schools_n=5),
    "160030": dict(crime=77, air=63, power=58, schools=64, water=86, roads=82, sewerage=76,
                   crimes=248, aqi=108, aqi_cat="Moderate", outage=2.9, rel=2, supply=6, tds="Medium",
                   wcov=94, road="Good", pot=2.0, resurf=2021, wlog=3, flood=3, zone="Mixed",
                   hwy="Medium", planned=1, schools_n=3),
    "160036": dict(crime=75, air=62, power=58, schools=80, water=85, roads=80, sewerage=74,
                   crimes=286, aqi=112, aqi_cat="Moderate", outage=2.9, rel=2, supply=6, tds="Medium",
                   wcov=93, road="Good", pot=2.2, resurf=2022, wlog=3, flood=3, zone="Residential",
                   hwy="Medium", planned=4, schools_n=13),
    "160047": dict(crime=73, air=61, power=58, schools=70, water=84, roads=79, sewerage=73,
                   crimes=304, aqi=115, aqi_cat="Moderate", outage=2.9, rel=2, supply=6, tds="Medium",
                   wcov=92, road="Average", pot=2.5, resurf=2020, wlog=3, flood=3, zone="Residential",
                   hwy="High", planned=2, schools_n=6),
    "160002": dict(crime=64, air=54, power=58, schools=48, water=79, roads=74, sewerage=66,
                   crimes=421, aqi=131, aqi_cat="Moderate", outage=2.9, rel=2, supply=5, tds="High",
                   wcov=87, road="Average", pot=3.4, resurf=2020, wlog=2, flood=5, zone="Industrial",
                   hwy="High", planned=1, schools_n=2),
    "160101": dict(crime=68, air=58, power=58, schools=66, water=81, roads=76, sewerage=69,
                   crimes=368, aqi=122, aqi_cat="Moderate", outage=2.9, rel=2, supply=5, tds="High",
    ...
    "160025": dict(crime=66, air=57, power=58, schools=54, water=80, roads=75, sewerage=68,
                   crimes=389, aqi=126, aqi_cat="Moderate", outage=2.9, rel=2, supply=5, tds="High",
                   wcov=88, road="Average", pot=3.2, resurf=2019, wlog=2, flood=5, zone="Residential",
                   hwy="Low", planned=1, schools_n=4),
    "160004": dict(crime=82, air=66, power=58, schools=41, water=87, roads=84, sewerage=79,
                   crimes=162, aqi=99, aqi_cat="Satisfactory", outage=2.9, rel=2, supply=7, tds="Medium",
                   wcov=94, road="Good", pot=1.8, resurf=2023, wlog=4, flood=1, zone="Institutional",
                   hwy="High", planned=1, schools_n=1),
    "160102": dict(crime=63, air=56, power=58, schools=52, water=77, roads=71, sewerage=63,
                   crimes=434, aqi=129, aqi_cat="Moderate", outage=2.9, rel=2, supply=4, tds="High",
