...
EASTERN_SUBURBS = {
    ...
    "400084": ("Kurla West (Barve Nagar)", "L Ward", 19.0760, 72.8810, "L", 4,
               []),
    "400085": ("BARC / Trombay", "M/West Ward", 19.0210, 72.9280, "M/W", 4,
               ["Bhabha Atomic Research Centre"]),
    "400094": ("Anushakti Nagar", "M/East Ward", 19.0280, 72.9230, "M/E", 4,
               ["Anushakti Nagar S.O. (BARC residential colony)", "Atomic Energy Education Society"]),
    "400042": ("Bhandup East", "S Ward", 19.1480, 72.9400, "S", 4,
               ["Bhandup Station (Central Line)", "Sonapur signal, L.B.S. Marg"]),
