...
Generated 2026-09-24 by `scripts/city_launch_checklist.py` — item 8 of the trust-framework checklist. Re-run this script after any data or scoring change; don't hand-edit this file.
...
- **7. Versioning & changelog in place**: CHANGELOG.md exists, currently at v1.16
