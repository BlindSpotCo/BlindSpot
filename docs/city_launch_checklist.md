...
Generated 2026-09-22 by `scripts/city_launch_checklist.py` — item 8 of the trust-framework checklist. Re-run this script after any data or scoring change; don't hand-edit this file.
...
- **6. Confidence/abstention logic present**: 1/41 pins have a _provenance entry on at least one field
- **7. Versioning & changelog in place**: CHANGELOG.md exists as of v1.4
...
- **6. Confidence/abstention logic present**: 13/96 pins have a _provenance entry on at least one field
- **7. Versioning & changelog in place**: CHANGELOG.md exists as of v1.4
