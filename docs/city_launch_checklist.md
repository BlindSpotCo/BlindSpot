...
Generated 2026-09-14 by `scripts/city_launch_checklist.py` - item 8 of the trust-framework checklist. Re-run this script after any data or scoring change; don't hand-edit this file.
...
| Hyderabad (n=41) | pass | FAIL | PENDING | PENDING | pass | FAIL | pass | **Keep labelled beta** |
| Mumbai (n=96) | pass | FAIL | PENDING | PENDING | pass | FAIL | pass | **Keep labelled beta** |
...
- **6. Confidence/abstention logic present**: 0/20 pins have a _provenance entry on at least one field
- **7. Versioning & changelog in place**: CHANGELOG.md exists as of v1.4
...
- **6. Confidence/abstention logic present**: 0/41 pins have a _provenance entry on at least one field
- **7. Versioning & changelog in place**: CHANGELOG.md exists as of v1.4
...
- **6. Confidence/abstention logic present**: 0/96 pins have a _provenance entry on at least one field
- **7. Versioning & changelog in place**: CHANGELOG.md exists as of v1.4
