  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800&family=Geist+Mono:wght@400;500;600&family=Fraunces:ital,wght@1,480&display=swap"
          rel="stylesheet"
        />
        <Script
          id="ld-json-website"
