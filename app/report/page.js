...
export const metadata = {
  ...
  // The root layout sets canonical:'/' and every route that doesn't override
  // it inherits that -- so every /report?lat=..&lon=.. page was telling
  // Google it was a duplicate of the homepage, and deindexing itself. This
  // page is per-address and has nothing useful to crawl without its params,
  // so it opts out of the index instead of claiming to be somewhere else.
