    ...
    <div style={{ marginBottom: 36 }}>
      ...
      {resolved && (
        <div style={{
          ...
          background: 'var(--bg-2)', border: '1.5px solid var(--brand)', borderRadius: 'var(--radius)',
          ...
          {!editingPincode ? (
            ...
            <>
              <input
                ...
                style={{ width: 100, background: 'var(--paper)', border: '1px solid var(--line)', borderRadius: 'var(--radius)', padding: '6px 10px', color: 'var(--text)', fontSize: 15, fontWeight: 700 }}
              />
              <button type="button" onClick={applyPincodeOverride} className="ps-btn ps-cta-btn"
                style={{ background: 'var(--brand)', color: '#fff', border: 'none', borderRadius: 'var(--radius)', padding: '7px 14px', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>
                Apply
              </button>
            </>
          )}
